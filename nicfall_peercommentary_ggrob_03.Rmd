---
title: "ggrob_OriginalHomeworkCode_03"
author: "Gianna Grob"
date: "10/2/2019"
...
Nicola Kriefall comments:

line 37: there was an extra 'f <- ' here so I deleted that

Question 1: I got the same answers for means but a different answer for the population standard deviations, but I don't know who's correct, so maybe we should check with our third group member?

Question 4: Nice job plotting the non-normal ones

Question 6: We got very different answers for standard deviations. Here I think it's because I constructed a list of 100 means first, then took the mean & standard deviation of the list of 100 means, whereas you calculated the mean & standard deviations of your entire sample data list (a list of thousands of values). I think if you had done it my way all of your plots in the end would have been normally distributed (even the ones that were non-normal originally), that's how mine ended up. 

Overall awesome job! Very well annotated
